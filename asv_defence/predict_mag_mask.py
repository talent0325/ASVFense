...
def main(args):
    ...
    plt.tight_layout()
    # plt.show()
    # plt.savefig("/mnt2/srb/code/defence/aero_mag/predict/mag_filtered_mask_25_1_0.1/103-1240-0001_epoch9.png")
    plt.savefig("/mnt1/asv/asv_defence/output/PGD/302-123504-0000.png")
    ...
    sf.write('/mnt1/asv/asv_defence/output/302-123504-0000.wav',waveform_trans,16000,'FLOAT')
